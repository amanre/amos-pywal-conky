#!/bin/sh
/usr/bin/.conky/conky-pywal/refresh_conky.sh
...
while inotifywait -qqe modify $HOME/.cache/wal/colors.Xresources; do /usr/bin/.conky/conky-pywal/refresh_conky.sh ; done
